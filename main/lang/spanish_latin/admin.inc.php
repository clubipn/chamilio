...
$langWebsite = "Web site de Chamilo";
...
$langYourDokeosUses = "Su instalación de Chamilo usa 'presently'";
...
$DokeosFolder = "Carpeta de Chamilo";
...
$langVisioconfDescription = "Chamilo Live Conferencing® es una herramienta estándar de videoconferencia que ofrece: mostrar diapositivas, pizarra para dibujar y escribir, audio/video duplex, chat. Sólo requiere de Flash® player y permite usar tres modos: uno a uno, uno a muchos, y mu";
$langPpt2lp = "PowerPoint2LearningPath";
$langPpt2lpDescription = "Oogie-Woogie es una herramienta de Aprendizaje Rápido. Le permite convertir las presentaciones de Power Point y los documentos de Word y sus equivalentes de OpenOffice en e-cursos SCORM-compatibles. Depués de la conversión, usted puede usar la herramienta";
